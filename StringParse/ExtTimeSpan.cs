...
namespace ca.canthonyparkinson.StringParse
{
    public static class ExtTimeSpan
    {
        extension(TimeSpan)
        {
            ...
            public static TimeSpan? TryParse(ReadOnlySpan<char> str) => (TimeSpan.TryParse(str, out TimeSpan val) ? new TimeSpan?(val) : null);
            public static TimeSpan? TryParse(ReadOnlySpan<char> str, IFormatProvider provider) => (TimeSpan.TryParse(str, provider, out TimeSpan val) ? new TimeSpan?(val) : null);
            ...
            public static TimeSpan? TryParseExact(ReadOnlySpan<char> str, string format, IFormatProvider provider) => (TimeSpan.TryParseExact(str, format, provider, out TimeSpan val) ? new TimeSpan?(val) : null);
            public static TimeSpan? TryParseExact(ReadOnlySpan<char> str, string[] formats, IFormatProvider provider) => (TimeSpan.TryParseExact(str, formats, provider, out TimeSpan val) ? new TimeSpan?(val) : null);
            public static TimeSpan? TryParseExact(ReadOnlySpan<char> str, string format, IFormatProvider provider, TimeSpanStyles style) => (TimeSpan.TryParseExact(str, format, provider, style, out TimeSpan val) ? new TimeSpan?(val) : null);
            public static TimeSpan? TryParseExact(ReadOnlySpan<char> str, string[] formats, IFormatProvider provider, TimeSpanStyles style) => (TimeSpan.TryParseExact(str, formats, provider, style, out TimeSpan val) ? new TimeSpan?(val) : null);
        }
    }
}
